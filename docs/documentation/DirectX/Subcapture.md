...
gitsPlayer.exe ... --Common.Player.Subcapture.DirectX.CommandListExecutions 2 --Common.Player.ExitFrame 1 ...   # sub-capture
# ... repeat the analysis/sub-capture pair for executions 3 through 49 ...
gitsPlayer.exe ... --Common.Player.Subcapture.DirectX.CommandListExecutions 50 --Common.Player.ExitFrame 1 ...  # analysis
gitsPlayer.exe ... --Common.Player.Subcapture.DirectX.CommandListExecutions 50 --Common.Player.ExitFrame 1 ...  # sub-capture
```
