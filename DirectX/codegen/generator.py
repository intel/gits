...
from generator_command_list_split import generate_command_list_split_files
...
def main():
    ...
    generate_coders_files(context, os.path.join(outpath, 'common/coders/src'))
    generate_dml_files(context, os.path.join(outpath, 'common/coders/src'))
    generate_xess_dispatch_table(context, [os.path.join(outpath, 'player'), os.path.join(outpath, 'recorder')])
    generate_layer_files(context, os.path.join(outpath, 'common/layer_interface/src'))
    ...
    generate_command_list_split_files(context, os.path.join(outpath, 'layers/command_list_split'))
