...
class CoclocInvoke_V1 : public CFunction {
  static const unsigned ARG_NUM = 11;
  static const unsigned RESULT_NUM = 1;
  ...
  Cuint64_t::CSArray _lenInputHeaders;
  CStringArray _headerIncludeNames;
  Cuint64_t::CSArray _originalHashes;
...
public:
  CoclocInvoke_V1() = default;
  CoclocInvoke_V1(int return_value,
                  unsigned int argc,
                  const char** argv,
                  const uint32_t numSources,
                  const uint8_t** sources,
