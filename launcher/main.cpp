...
static void SetupWindow() {
  ...
  g_WC = {
      sizeof(g_WC), CS_CLASSDC, WndProc,         0L,   0L, GetModuleHandle(nullptr), hIcon, nullptr,
      nullptr,      nullptr,    L"gitsLauncher", hIcon};
  RegisterClassExW(&g_WC);

  g_MainWindowHWnd = CreateWindowW(
      g_WC.lpszClassName, gits::gui::Settings::WINDOW_TITLE, WS_OVERLAPPEDWINDOW,
