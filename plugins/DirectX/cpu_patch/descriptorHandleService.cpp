...
bool DescriptorHandleService::getViewMappings(std::vector<DescriptorMapping>& mappings) {
...
bool DescriptorHandleService::getSamplerMappings(std::vector<DescriptorMapping>& mappings) {
...
DescriptorHandleService::DescriptorHeapInfo* DescriptorHandleService::getViewDescriptorHeapInfo(
    DescriptorHandleMap& descriptorHandleMap, UINT64 handle, bool fromCapture) {
