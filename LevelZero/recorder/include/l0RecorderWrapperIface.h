...
#include "l0WrapperFunctionsIface.h"
  ...
  virtual void zeCommandListImmediateAppendCommandListsExp_pre(
  ...
  virtual void zeCommandListAppendLaunchMultipleKernelsIndirect_pre(
      ...
      uint32_t numWaitEvents,
      ze_event_handle_t* phWaitEvents) const = 0;
  virtual void zeCommandListAppendLaunchCooperativeKernel_pre(
      ze_result_t return_value,
      ze_command_list_handle_t hCommandList,
      ze_kernel_handle_t hKernel,
      const ze_group_count_t* pLaunchFuncArgs,
      ...
      uint32_t numWaitEvents,
      ze_event_handle_t* phWaitEvents) const = 0;
  virtual void zeCommandListAppendLaunchKernelIndirect_pre(
      ze_result_t return_value,
      ze_command_list_handle_t hCommandList,
      ze_kernel_handle_t hKernel,
      const ze_group_count_t* pLaunchArgumentsBuffer,
