...
CustomFunction(name='vkPassPhysicalDeviceMemoryPropertiesGITS', enabled=True, type=FuncType.PARAM, stateTrack=True, runWrap=True, recWrap=True, customDriver=True, level=FuncLevel.INSTANCE,
...
CustomFunction(name='vkGetBufferDeviceAddressUnifiedGITS', enabled=True, type=FuncType.PARAM, stateTrack=True, recWrap=True, runWrap=True,
...
CustomFunction(name='vkGetBufferOpaqueCaptureAddressUnifiedGITS', enabled=False, type=FuncType.NONE,
retV=RetDef(type='uint64_t'),
arg1=ArgDef(name='device', type='VkDevice'),
arg2=ArgDef(name='pInfo', type='const VkBufferDeviceAddressInfo*')
)

CustomFunction(name='vkGetDeviceMemoryOpaqueCaptureAddressUnifiedGITS', enabled=False, type=FuncType.PARAM,
retV=RetDef(type='uint64_t'),
arg1=ArgDef(name='device', type='VkDevice'),
arg2=ArgDef(name='pInfo', type='const VkDeviceMemoryOpaqueCaptureAddressInfo*')
)

CustomFunction(name='vkCmdPipelineBarrier2UnifiedGITS', enabled=True, type=FuncType.PARAM, stateTrack=True, recWrap=True, tokenCache="SD()._commandbufferstates[commandBuffer]->tokensBuffer",
retV=RetDef(type='void'),
arg1=ArgDef(name='commandBuffer', type='VkCommandBuffer'),
arg2=ArgDef(name='pDependencyInfo', type='const VkDependencyInfo*')
)

CustomFunction(name='vkTagMemoryContentsUpdateGITS', enabled=False, type=FuncType.PARAM, recWrap=True, customDriver=True,
retV=RetDef(type='void'),
arg1=ArgDef(name='device', type='VkDevice'),
...
CustomFunction(name='vkIAmGITS', enabled=False, type=FuncType.PARAM, recExecWrap=True, stateTrack=True, level=FuncLevel.GLOBAL, pluginWrap=True,
retV=RetDef(type='void')
)

CustomFunction(name='vkGetAccelerationStructureDeviceAddressUnifiedGITS', enabled=True, type=FuncType.PARAM, stateTrack=True, recWrap=False, runWrap=True,
retV=RetDef(type='VkDeviceAddress'),
arg1=ArgDef(name='device', type='VkDevice'),
arg2=ArgDef(name='pInfo', type='const VkAccelerationStructureDeviceAddressInfoKHR*')
)

CustomFunction(name='vkPauseRecordingGITS', enabled=False, type=FuncType.PARAM, recExecWrap=True, level=FuncLevel.GLOBAL, customDriver=True,
retV=RetDef(type='void')
)

CustomFunction(name='vkContinueRecordingGITS', enabled=False, type=FuncType.PARAM, recExecWrap=True, level=FuncLevel.GLOBAL, customDriver=True,
retV=RetDef(type='void')
)

CustomFunction(name='vkIAmRecorderGITS', enabled=False, type=FuncType.PARAM, level=FuncLevel.GLOBAL, customDriver=True, disableInPlugin=True,
retV=RetDef(type='void')
)

CustomFunction(name='vkWaitSemaphoresUnifiedGITS', enabled=False, type=FuncType.PARAM, waitOperation=True,
...
CustomFunction(name='vkGetSemaphoreCounterValueUnifiedGITS', enabled=False, type=FuncType.PARAM,
retV=RetDef(type='VkResult'),
arg1=ArgDef(name='device', type='VkDevice'),
...
ExtendedEnum(name='VkFormat', enumerators = [
...
CustomStruct(name='VkInitializeImageGITS_', enabled=True, declareArray=True,
...
CustomStruct(name='VkInitializeImageDataGITS_', enabled=True, declareArray=True,
...
CustomStruct(name='VkInitializeBufferDataGITS_', enabled=True, declareArray=True,
var1=VarDef(name='buffer', type='VkBuffer'),
var2=VarDef(name='bufferCopy', type='VkBufferCopy')
)

CustomStruct(name='VkBufferDeviceAddressGITS_', enabled=False,
...
CustomStruct(name='VkOriginalShaderGroupHandlesGITS_', enabled=True,
var1=VarDef(name='sType', type='VkStructureType'),
var2=VarDef(name='pNext', type='const void*'),
