...
ID_VK_GET_MEMORY_WIN32HANDLE_KHR,
ID_VK_CMD_BEGIN_RENDERING_KHR,
ID_VK_CMD_END_RENDERING_KHR,
ID_VK_CMD_WAIT_EVENTS2KHR,
ID_VK_CMD_WAIT_EVENTS2,
ID_VK_INVALIDATE_MAPPED_MEMORY_RANGES,
ID_VK_CMD_TRACE_RAYS_INDIRECT_KHR,
ID_VK_CMD_SET_DISCARD_RECTANGLE_ENABLE_EXT,
ID_VK_CMD_SET_FRONT_FACE_EXT,
ID_VK_CMD_SET_PRIMITIVE_TOPOLOGY,
ID_VK_CMD_SET_PRIMITIVE_TOPOLOGY_EXT,
ID_VK_CMD_SET_SCISSOR_WITH_COUNT_EXT,
ID_VK_CMD_SET_VIEWPORT_WITH_COUNT_EXT,
ID_VK_CREATE_SAMPLER_YCBCR_CONVERSION,
ID_VK_CREATE_SAMPLER_YCBCR_CONVERSION_KHR,
ID_VK_DESTROY_SAMPLER_YCBCR_CONVERSION,
ID_VK_DESTROY_SAMPLER_YCBCR_CONVERSION_KHR,
ID_VK_CMD_SET_DEPTH_BIAS2EXT,
ID_VK_WAIT_FOR_PRESENT_KHR,
ID_VK_LATENCY_SLEEP_NV,
ID_VK_SET_LATENCY_SLEEP_MODE_NV,
ID_VK_RECORDED_ON_TRINITY_GITS,
ID_VK_CMD_SET_DEPTH_CLIP_ENABLE_EXT,
ID_VK_CMD_SET_RASTERIZER_DISCARD_ENABLE,
ID_VK_CMD_SET_RASTERIZER_DISCARD_ENABLE_EXT,
ID_VK_QUEUE_SET_RESIDENCY_INTEL,
ID_VK_CMD_DISABLE_PREDICATION_FROM_QUERY_INTEL,
ID_VK_CMD_SET_IMAGE_CLEAR_COLOR_VALUE_INTEL,
ID_VK_QUEUE_SYNC_INTEL,
ID_VK_ROTATE_RESOURCE_IDENTITIES_INTEL,
ID_VK_TRIM_RESIDENCY_SET_INTEL,
ID_VK_CMD_BUILD_MICROMAPS_EXT,
ID_VK_CREATE_MICROMAP_EXT,
ID_VK_DESTROY_MICROMAP_EXT,
ID_VK_CMD_COPY_MICROMAP_EXT,
ID_VK_CMD_BIND_INDEX_BUFFER2,
ID_VK_CMD_BIND_INDEX_BUFFER2KHR,
ID_VK_CMD_PUSH_DESCRIPTOR_SET,
ID_VK_CMD_SET_LINE_STIPPLE,
ID_VK_CMD_SET_LINE_STIPPLE_EXT,
ID_VK_CMD_SET_LINE_STIPPLE_KHR,
ID_VK_MAP_MEMORY2,
ID_VK_MAP_MEMORY2KHR,
ID_VK_UNMAP_MEMORY2,
ID_VK_UNMAP_MEMORY2KHR,
ID_VK_CMD_SET_VERTEX_INPUT_EXT,
