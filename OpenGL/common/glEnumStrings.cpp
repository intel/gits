...
/**
 * @file   glEnumString.cpp/openglCommon.h
 *
 * @brief Definition of enums map function.
 *
 */
...
const EnumStringPair enums[] = {
    ...
    {0xFFFFFFFF, "GL_ALL_BARRIER_BITS_EXT"},
    ...
    {0x8193, "GL_SPOT_CUTOFF_DELTA_SGIX"},
    ...
    {0x819E, "GL_IGLOO_FULLSCREEN_SGIX"},
    {0x819F, "GL_IGLOO_VIEWPORT_OFFSET_SGIX"},
    {0x81A0, "GL_IGLOO_SWAPTMESH_SGIX"},
    {0x81A1, "GL_IGLOO_COLORNORMAL_SGIX"},
    {0x81A2, "GL_IGLOO_IRISGL_MODE_SGIX"},
    {0x81A3, "GL_IGLOO_LMC_COLOR_SGIX"},
    {0x81A4, "GL_IGLOO_TMESHMODE_SGIX"},
    ...
    {0x81BD, "GL_COMPLEX_UNSIGNED_BYTE_SGI"},
    {0x81BE, "GL_COMPLEX_BYTE_SGI"},
    {0x81BF, "GL_COMPLEX_UNSIGNED_SHORT_SGI"},
    {0x81C0, "GL_COMPLEX_SHORT_SGI"},
    {0x81C1, "GL_COMPLEX_UNSIGNED_INT_SGI"},
    {0x81C2, "GL_COMPLEX_INT_SGI"},
    {0x81C3, "GL_COMPLEX_FLOAT_SGI"},
    {0x81C4, "GL_PIXEL_TRANSFORM_OPERATOR_SGI"},
    {0x81C5, "GL_CONVOLUTION_SGI"},
    {0x81C6, "GL_FFT_1D_SGI"},
    {0x81C7, "GL_PIXEL_TRANSFORM_SGI"},
    {0x81C8, "GL_MAX_FFT_WIDTH_SGI"},
    {0x81C9, "GL_SORT_SGI"},
    {0x81CA, "GL_TRANSPOSE_SGI"},
    {0x81CB, "GL_MAP1_VERTEX_3_NURBS_SGIX"},
    {0x81CC, "GL_MAP1_VERTEX_4_NURBS_SGIX"},
    {0x81CD, "GL_MAP1_INDEX_NURBS_SGIX"},
    {0x81CE, "GL_MAP1_COLOR_4_NURBS_SGIX"},
    {0x81CF, "GL_MAP1_NORMAL_NURBS_SGIX"},
    {0x81E0, "GL_MAP1_TEXTURE_COORD_1_NURBS_SGIX"},
    {0x81E1, "GL_MAP1_TEXTURE_COORD_2_NURBS_SGIX"},
    {0x81E2, "GL_MAP1_TEXTURE_COORD_3_NURBS_SGIX"},
    {0x81E3, "GL_MAP1_TEXTURE_COORD_4_NURBS_SGIX"},
    {0x81E4, "GL_MAP2_VERTEX_3_NURBS_SGIX"},
    {0x81E5, "GL_MAP2_VERTEX_4_NURBS_SGIX"},
    {0x81E6, "GL_MAP2_INDEX_NURBS_SGIX"},
    {0x81E7, "GL_MAP2_COLOR_4_NURBS_SGIX"},
    {0x81E8, "GL_MAP2_NORMAL_NURBS_SGIX"},
    {0x81E9, "GL_MAP2_TEXTURE_COORD_1_NURBS_SGIX"},
    {0x81EA, "GL_MAP2_TEXTURE_COORD_2_NURBS_SGIX"},
    {0x81EB, "GL_MAP2_TEXTURE_COORD_3_NURBS_SGIX"},
    {0x81EC, "GL_MAP2_TEXTURE_COORD_4_NURBS_SGIX"},
    {0x81ED, "GL_NURBS_KNOT_COUNT_SGIX"},
    {0x81EE, "GL_NURBS_KNOT_VECTOR_SGIX"},
    {0x81D2, "GL_SURFACE_SIZE_HINT_SUNX"},
    {0x81D3, "GL_LARGE_SUNX"},
    ...
    {0x81FE, "GL_FOG_BLEND_ALPHA_SGIX"},
    {0x81FF, "GL_FOG_BLEND_COLOR_SGIX"},
    ...
    {0x8267, "GL_COMPUTE_LOCAL_WORK_SIZE"},
    ...
    {0x8323, "GL_FOG_TYPE_SGIX"},
    {0x8324, "GL_UNIFORM_SGIX"},
    {0x8325, "GL_LAYERED_SGIX"},
    {0x8326, "GL_FOG_GROUND_PLANE_SGIX"},
    {0x8327, "GL_FOG_LAYERS_POINTS_SGIX"},
    {0x8328, "GL_MAX_FOG_LAYERS_POINTS_SGIX"},
    {0x8329, "GL_ASYNC_MARKER_SGIX"},
    {0x832A, "GL_PHASE_SGIX"},
    {0x832C, "GL_ASYNC_HISTOGRAM_SGIX"},
    {0x832D, "GL_MAX_ASYNC_HISTOGRAM_SGIX"},
    {0x832E, "GL_TEXTURE_MIPMAP_ANISOTROPY_SGIX"},
    {0x832F, "GL_MAX_MIPMAP_ANISOTROPY_SGIX"},
    ...
    {0x8340, "GL_ENV_MAP_SGIX"},
    {0x8341, "GL_CUBE_MAP_SGIX"},
    {0x8342, "GL_CUBE_MAP_ZP_SGIX"},
    {0x8343, "GL_CUBE_MAP_ZN_SGIX"},
    {0x8344, "GL_CUBE_MAP_XN_SGIX"},
    {0x8345, "GL_CUBE_MAP_XP_SGIX"},
    {0x8346, "GL_CUBE_MAP_YN_SGIX"},
    {0x8347, "GL_CUBE_MAP_YP_SGIX"},
    {0x8348, "GL_CUBE_MAP_BINDING_SGIX"},
    ...
    {0x8357, "GL_COLOR_TO_TEXTURE_COORD_SGIX"},
    {0x8358, "GL_COLOR_BIT_PATTERN_SGIX"},
    {0x8359, "GL_COLOR_VALUE_SGIX"},
    {0x835A, "GL_PIXEL_TEX_GEN_LAMBDA_SOURCE_SGIX"},
    ...
    {0x836C, "GL_FRAGMENT_FOG_SGIX"},
    {0x836D, "GL_TEXTURE_FOG_SGIX"},
    {0x836E, "GL_FOG_PATCHY_FACTOR_SGIX"},
    ...
    {0x83C0, "GL_SELECTED_TEXTURE_SGIS"},
    {0x83C1, "GL_SELECTED_TEXTURE_COORD_SET_SGIS"},
    {0x83C2, "GL_SELECTED_TEXTURE_TRANSFORM_SGIS"},
    {0x83C3, "GL_MAX_TEXTURES_SGIS"},
    {0x83C4, "GL_MAX_TEXTURE_COORD_SETS_SGIS"},
    {0x83C5, "GL_TEXTURE_COORD_SET_INTERLEAVE_FACTOR_SGIS"},
    {0x83C6, "GL_TEXTURE_ENV_COORD_SET_SGIS"},
    {0x83C7, "GL_TEXTURE0_SGIS"},
    {0x83C8, "GL_TEXTURE1_SGIS"},
    {0x83C9, "GL_TEXTURE2_SGIS"},
    {0x83CA, "GL_TEXTURE3_SGIS"},
    {0x83E6, "GL_BALI_NUM_TRIS_CULLED_INSTRUMENT_SGIX"},
    {0x83E7, "GL_BALI_NUM_PRIMS_CLIPPED_INSTRUMENT_SGIX"},
    {0x83E8, "GL_BALI_NUM_PRIMS_REJECT_INSTRUMENT_SGIX"},
    {0x83E9, "GL_BALI_NUM_PRIMS_CLIP_RESULT_INSTRUMENT_SGIX"},
    {0x83EA, "GL_BALI_FRAGMENTS_GENERATED_INSTRUMENT_SGIX"},
    {0x83EB, "GL_BALI_DEPTH_PASS_INSTRUMENT_SGIX"},
    {0x83EC, "GL_BALI_R_CHIP_COUNT_SGIX"},
    {0x83ED, "GL_OCCLUSION_INSTRUMENT_SGIX"},
    ...
    {0x8436, "GL_EYE_SPACE_SGIX"},
    {0x8437, "GL_TANGENT_SPACE_SGIX"},
    {0x8438, "GL_OBJECT_SPACE_SGIX"},
    {0x8439, "GL_TANGENT_ARRAY_SGIX"},
    {0x843A, "GL_BINORMAL_ARRAY_SGIX"},
    {0x843B, "GL_CURRENT_TANGENT_SGIX"},
    {0x843C, "GL_CURRENT_BINORMAL_SGIX"},
    {0x843D, "GL_FRAGMENT_LIGHT_SPACE_SGIX"},
    {0x843E, "GL_TANGENT_ARRAY_TYPE_SGIX"},
    {0x843F, "GL_TANGENT_ARRAY_STRIDE_SGIX"},
    {0x8440, "GL_TANGENT_ARRAY_COUNT_SGIX"},
    {0x8441, "GL_BINORMAL_ARRAY_TYPE_SGIX"},
    {0x8442, "GL_BINORMAL_ARRAY_STRIDE_SGIX"},
    {0x8443, "GL_BINORMAL_ARRAY_COUNT_SGIX"},
    {0x8444, "GL_TANGENT_ARRAY_POINTER_SGIX"},
    {0x8445, "GL_BINORMAL_ARRAY_POINTER_SGIX"},
    {0x8446, "GL_MAP1_TANGENT_SGIX"},
    {0x8447, "GL_MAP2_TANGENT_SGIX"},
    {0x8448, "GL_MAP1_BINORMAL_SGIX"},
    {0x8449, "GL_MAP2_BINORMAL_SGIX"},
    {0x844A, "GL_BALI_GEOM_TIMER_INSTRUMENT_SGIX"},
    {0x844B, "GL_BALI_RASTER_TIMER_INSTRUMENT_SGIX"},
    {0x844C, "GL_BALI_INSTRUMENT_TIME_UNIT_SGIX"},
    ...
    {0x8460, "GL_RGB_ICC_SGIX"},
    {0x8461, "GL_RGBA_ICC_SGIX"},
    {0x8462, "GL_ALPHA_ICC_SGIX"},
    {0x8463, "GL_LUMINANCE_ICC_SGIX"},
    {0x8464, "GL_INTENSITY_ICC_SGIX"},
    {0x8465, "GL_LUMINANCE_ALPHA_ICC_SGIX"},
    {0x8466, "GL_R5_G6_B5_ICC_SGIX"},
    {0x8467, "GL_R5_G6_B5_A8_ICC_SGIX"},
    {0x8468, "GL_ALPHA16_ICC_SGIX"},
    {0x8469, "GL_LUMINANCE16_ICC_SGIX"},
    {0x846A, "GL_INTENSITY16_ICC_SGIX"},
    {0x846B, "GL_LUMINANCE16_ALPHA8_ICC_SGIX"},
    ...
    {0x85A5, "GL_EXTENDED_RANGE_SGIS"},
    {0x85A6, "GL_MIN_RED_SGIS"},
    {0x85A7, "GL_MAX_RED_SGIS"},
    {0x85A8, "GL_MIN_GREEN_SGIS"},
    {0x85A9, "GL_MAX_GREEN_SGIS"},
    {0x85AA, "GL_MIN_BLUE_SGIS"},
    {0x85AB, "GL_MAX_BLUE_SGIS"},
    {0x85AC, "GL_MIN_ALPHA_SGIS"},
    {0x85AD, "GL_MAX_ALPHA_SGIS"},
    ...
    {0x85B6, "GL_TEXTURE_MINIMIZE_STORAGE_APPLE"},
    ...
    {0x85D0, "GL_FACET_NORMAL_AUTODESK"},
    {0x85D1, "GL_FACET_NORMAL_ARRAY_AUTODESK"},
    {0x85E0, "GL_RGB_SIGNED_SGIX"},
    {0x85E1, "GL_RGBA_SIGNED_SGIX"},
    {0x85E2, "GL_ALPHA_SIGNED_SGIX"},
    {0x85E3, "GL_LUMINANCE_SIGNED_SGIX"},
    {0x85E4, "GL_INTENSITY_SIGNED_SGIX"},
    {0x85E5, "GL_LUMINANCE_ALPHA_SIGNED_SGIX"},
    {0x85E6, "GL_RGB16_SIGNED_SGIX"},
    {0x85E7, "GL_RGBA16_SIGNED_SGIX"},
    {0x85E8, "GL_ALPHA16_SIGNED_SGIX"},
    {0x85E9, "GL_LUMINANCE16_SIGNED_SGIX"},
    {0x85EA, "GL_INTENSITY16_SIGNED_SGIX"},
    {0x85EB, "GL_LUMINANCE16_ALPHA16_SIGNED_SGIX"},
    {0x85EC, "GL_RGB_EXTENDED_RANGE_SGIX"},
    {0x85ED, "GL_RGBA_EXTENDED_RANGE_SGIX"},
    {0x85EE, "GL_ALPHA_EXTENDED_RANGE_SGIX"},
    {0x85EF, "GL_LUMINANCE_EXTENDED_RANGE_SGIX"},
    {0x85F0, "GL_INTENSITY_EXTENDED_RANGE_SGIX"},
    {0x85F1, "GL_LUMINANCE_ALPHA_EXTENDED_RANGE_SGIX"},
    {0x85F2, "GL_RGB16_EXTENDED_RANGE_SGIX"},
    {0x85F3, "GL_RGBA16_EXTENDED_RANGE_SGIX"},
    {0x85F4, "GL_ALPHA16_EXTENDED_RANGE_SGIX"},
    {0x85F5, "GL_LUMINANCE16_EXTENDED_RANGE_SGIX"},
    {0x85F6, "GL_INTENSITY16_EXTENDED_RANGE_SGIX"},
    {0x85F7, "GL_LUMINANCE16_ALPHA16_EXTENDED_RANGE_SGIX"},
    {0x85F8, "GL_MIN_LUMINANCE_SGIS"},
    {0x85F9, "GL_MAX_LUMINANCE_SGIS"},
    {0x85FA, "GL_MIN_INTENSITY_SGIS"},
    {0x85FB, "GL_MAX_INTENSITY_SGIS"},
    ...
    {0x874A, "GL_SET_AMD"},
    {0x874B, "GL_REPLACE_VALUE_AMD"},
    {0x874C, "GL_STENCIL_OP_VALUE_AMD"},
    {0x874D, "GL_STENCIL_BACK_OP_VALUE_AMD"},
    ...
    {0xFFFF, "GL_TRACE_ALL_BITS_MESA"},
    {0x0001, "GL_TRACE_OPERATIONS_BIT_MESA"},
    {0x0002, "GL_TRACE_PRIMITIVES_BIT_MESA"},
    {0x0004, "GL_TRACE_ARRAYS_BIT_MESA"},
    {0x0008, "GL_TRACE_TEXTURES_BIT_MESA"},
    {0x0010, "GL_TRACE_PIXELS_BIT_MESA"},
    {0x0020, "GL_TRACE_ERRORS_BIT_MESA"},
    ...
    {0x8864, "GL_PIXEL_COUNTER_BITS_NV"},
    ...
    {0x88F2, "GL_STENCIL_TAG_BITS_EXT"},
    ...
    {0x898D, "GL_MODELVIEW_MATRIX_FLOAT_AS_INT_BITS_OES"},
    {0x898E, "GL_PROJECTION_MATRIX_FLOAT_AS_INT_BITS_OES"},
    {0x898F, "GL_TEXTURE_MATRIX_FLOAT_AS_INT_BITS_OES"},
    ...
    {0x8A10, "GL_MIN_PBUFFER_VIEWPORT_DIMS_APPLE"},
    ...
    {0x8E5D, "GL_FRAGMENT_PROGRAM_INTERPOLATION_OFFSET_BITS_NV"},
    ...
    {0x9085, "GL_PATH_SAMPLE_QUALITY_NV"},
    {0x9086, "GL_PATH_STROKE_BOUND_NV"},
    {0x9087, "GL_PATH_STROKE_OVERSAMPLE_COUNT_NV"},
    {0x9088, "GL_COUNT_UP_NV"},
    {0x9089, "GL_COUNT_DOWN_NV"},
    {0x908A, "GL_PATH_OBJECT_BOUNDING_BOX_NV"},
    {0x908B, "GL_CONVEX_HULL_NV"},
    {0x908C, "GL_MULTI_HULLS_NV"},
    ...
    {0x9093, "GL_PROJECTIVE_2D_NV"},
    {0x9094, "GL_AFFINE_3D_NV"},
    {0x9095, "GL_PROJECTIVE_3D_NV"},
    {0x9096, "GL_TRANSPOSE_AFFINE_2D_NV"},
    {0x9097, "GL_TRANSPOSE_PROJECTIVE_2D_NV"},
    {0x9098, "GL_TRANSPOSE_AFFINE_3D_NV"},
    {0x9099, "GL_TRANSPOSE_PROJECTIVE_3D_NV"},
    {0x909A, "GL_UTF8_NV"},
    {0x909B, "GL_UTF16_NV"},
    ...
    {0x90AC, "GL_PATH_FOG_GEN_MODE_NV"},
    ...
    {0x90B2, "GL_PATH_GEN_COLOR_FORMAT_NV"},
    ...
    // These two come from two separate GL extensions, but they have the same value because they
    // are used in the same way; one in glSemaphoreParameter*/glGetSemaphoreParameter* functions
    // and the other in their NV variants.
    {0x9595, "GL_D3D12_FENCE_VALUE_EXT"},
    {0x9595, "GL_TIMELINE_SEMAPHORE_VALUE_NV"},
    ...
    {0x95B3, "GL_SEMAPHORE_TYPE_NV"},
    {0x95B4, "GL_SEMAPHORE_TYPE_BINARY_NV"},
    {0x95B5, "GL_SEMAPHORE_TYPE_TIMELINE_NV"},
    ...
    {0x01, "GL_BOLD_BIT_NV"},
    {0x02, "GL_ITALIC_BIT_NV"},
    {0x01, "GL_GLYPH_WIDTH_BIT_NV"},
    {0x02, "GL_GLYPH_HEIGHT_BIT_NV"},
    ...
    {0x100, "GL_GLYPH_HAS_KERNING_NV"},
    {0x00010000, "GL_FONT_X_MIN_BOUNDS_NV"},
    {0x00020000, "GL_FONT_Y_MIN_BOUNDS_NV"},
    {0x00040000, "GL_FONT_X_MAX_BOUNDS_NV"},
    {0x00080000, "GL_FONT_Y_MAX_BOUNDS_NV"},
    {0x00100000, "GL_FONT_UNITS_PER_EM_NV"},
    {0x00200000, "GL_FONT_ASCENDER_NV"},
    {0x00400000, "GL_FONT_DESCENDER_NV"},
    {0x00800000, "GL_FONT_HEIGHT_NV"},
    {0x01000000, "GL_FONT_MAX_ADVANCE_WIDTH_NV"},
    {0x02000000, "GL_FONT_MAX_ADVANCE_HEIGHT_NV"},
    {0x04000000, "GL_FONT_UNDERLINE_POSITION_NV"},
    {0x08000000, "GL_FONT_UNDERLINE_THICKNESS_NV"},
    {0x10000000, "GL_FONT_HAS_KERNING_NV"},
    ...
    {0x90EB, "GL_MAX_COMPUTE_LOCAL_INVOCATIONS"},
    ...
    {0x9160, "GL_EXTERNAL_VIRTUAL_MEMORY_BUFFER_AMD"},
    {0x9192, "GL_QUERY_BUFFER_AMD"},
    {0x9193, "GL_QUERY_BUFFER_BINDING_AMD"},
    {0x9194, "GL_QUERY_RESULT_NO_WAIT_AMD"},
    ...
    {0x9240, "GL_UNPACK_FLIP_Y_WEBGL"},
    {0x9241, "GL_UNPACK_PREMULTIPLY_ALPHA_WEBGL"},
    {0x9242, "GL_CONTEXT_LOST_WEBGL"},
    {0x9243, "GL_UNPACK_COLORSPACE_CONVERSION_WEBGL"},
    {0x9244, "GL_BROWSER_DEFAULT_WEBGL"},
    ...
    {0x3027, "EGL_CONFIG_CAVEAT"},
    {0x3028, "EGL_CONFIG_ID"},
    {0x3029, "EGL_LEVEL"},
    {0x302A, "EGL_MAX_PBUFFER_HEIGHT"},
    {0x302B, "EGL_MAX_PBUFFER_PIXELS"},
    {0x302C, "EGL_MAX_PBUFFER_WIDTH"},
    {0x302D, "EGL_NATIVE_RENDERABLE"},
    {0x302E, "EGL_NATIVE_VISUAL_ID"},
    {0x302F, "EGL_NATIVE_VISUAL_TYPE"},
    {0x3031, "EGL_SAMPLES"},
    {0x3032, "EGL_SAMPLE_BUFFERS"},
    {0x3033, "EGL_SURFACE_TYPE"},
    {0x3034, "EGL_TRANSPARENT_TYPE"},
    {0x3035, "EGL_TRANSPARENT_BLUE_VALUE"},
    {0x3036, "EGL_TRANSPARENT_GREEN_VALUE"},
    {0x3037, "EGL_TRANSPARENT_RED_VALUE"},
    {0x3038, "EGL_NONE"},
    {0x3039, "EGL_BIND_TO_TEXTURE_RGB"},
    {0x303A, "EGL_BIND_TO_TEXTURE_RGBA"},
    {0x303B, "EGL_MIN_SWAP_INTERVAL"},
    {0x303C, "EGL_MAX_SWAP_INTERVAL"},
    {0x303D, "EGL_LUMINANCE_SIZE"},
    {0x303E, "EGL_ALPHA_MASK_SIZE"},
    {0x303F, "EGL_COLOR_BUFFER_TYPE"},
    {0x3040, "EGL_RENDERABLE_TYPE"},
    {0x3041, "EGL_MATCH_NATIVE_PIXMAP"},
    {0x3042, "EGL_CONFORMANT"},
    {0x3050, "EGL_SLOW_CONFIG"},
    {0x3051, "EGL_NON_CONFORMANT_CONFIG"},
    {0x3052, "EGL_TRANSPARENT_RGB"},
    {0x308E, "EGL_RGB_BUFFER"},
    {0x308F, "EGL_LUMINANCE_BUFFER"},
    {0x305C, "EGL_NO_TEXTURE"},
    {0x305D, "EGL_TEXTURE_RGB"},
    {0x305E, "EGL_TEXTURE_RGBA"},
    {0x305F, "EGL_TEXTURE_2D"},
    {0x0001, "EGL_PBUFFER_BIT"},
    {0x0002, "EGL_PIXMAP_BIT"},
    {0x0004, "EGL_WINDOW_BIT"},
    {0x0020, "EGL_VG_COLORSPACE_LINEAR_BIT"},
    {0x0040, "EGL_VG_ALPHA_FORMAT_PRE_BIT"},
    {0x0200, "EGL_MULTISAMPLE_RESOLVE_BOX_BIT"},
    {0x0400, "EGL_SWAP_BEHAVIOR_PRESERVED_BIT"},
    {0x0001, "EGL_OPENGL_ES_BIT"},
    {0x0002, "EGL_OPENVG_BIT"},
    {0x0004, "EGL_OPENGL_ES2_BIT"},
    {0x0008, "EGL_OPENGL_BIT"},
    {0x3053, "EGL_VENDOR"},
    {0x3054, "EGL_VERSION"},
    {0x3055, "EGL_EXTENSIONS"},
    {0x308D, "EGL_CLIENT_APIS"},
    {0x3056, "EGL_HEIGHT"},
    {0x3057, "EGL_WIDTH"},
    {0x3058, "EGL_LARGEST_PBUFFER"},
    {0x3080, "EGL_TEXTURE_FORMAT"},
    {0x3081, "EGL_TEXTURE_TARGET"},
    {0x3082, "EGL_MIPMAP_TEXTURE"},
    {0x3083, "EGL_MIPMAP_LEVEL"},
    {0x3086, "EGL_RENDER_BUFFER"},
    {0x3087, "EGL_VG_COLORSPACE"},
    {0x3088, "EGL_VG_ALPHA_FORMAT"},
    {0x3090, "EGL_HORIZONTAL_RESOLUTION"},
    {0x3091, "EGL_VERTICAL_RESOLUTION"},
    {0x3092, "EGL_PIXEL_ASPECT_RATIO"},
    {0x3093, "EGL_SWAP_BEHAVIOR"},
    {0x3099, "EGL_MULTISAMPLE_RESOLVE"},
    {0x3084, "EGL_BACK_BUFFER"},
    {0x3085, "EGL_SINGLE_BUFFER"},
    {0x3089, "EGL_VG_COLORSPACE_sRGB"},
    {0x308A, "EGL_VG_COLORSPACE_LINEAR"},
    {0x308B, "EGL_VG_ALPHA_FORMAT_NONPRE"},
    {0x308C, "EGL_VG_ALPHA_FORMAT_PRE"},
    {10000, "EGL_DISPLAY_SCALING"},
    {0x3094, "EGL_BUFFER_PRESERVED"},
    {0x3095, "EGL_BUFFER_DESTROYED"},
    {0x3096, "EGL_OPENVG_IMAGE"},
    {0x3097, "EGL_CONTEXT_CLIENT_TYPE"},
    {0x3098, "EGL_CONTEXT_CLIENT_VERSION"},
    {0x309A, "EGL_MULTISAMPLE_RESOLVE_DEFAULT"},
    {0x309B, "EGL_MULTISAMPLE_RESOLVE_BOX"},
    {0x30A0, "EGL_OPENGL_ES_API"},
    {0x30A1, "EGL_OPENVG_API"},
    {0x30A2, "EGL_OPENGL_API"},
    {0x3059, "EGL_DRAW"},
    {0x305A, "EGL_READ"},
    {0x305B, "EGL_CORE_NATIVE_ENGINE"},
    {0x3042, "EGL_CONFORMANT_KHR"},
    {0x0020, "EGL_VG_COLORSPACE_LINEAR_BIT_KHR"},
    {0x0040, "EGL_VG_ALPHA_FORMAT_PRE_BIT_KHR"},
    {0x0001, "EGL_READ_SURFACE_BIT_KHR"},
    {0x0002, "EGL_WRITE_SURFACE_BIT_KHR"},
    {0x0080, "EGL_LOCK_SURFACE_BIT_KHR"},
    {0x0100, "EGL_OPTIMAL_FORMAT_BIT_KHR"},
    {0x3043, "EGL_MATCH_FORMAT_KHR"},
    {0x30C0, "EGL_FORMAT_RGB_565_EXACT_KHR"},
    {0x30C1, "EGL_FORMAT_RGB_565_KHR"},
    {0x30C2, "EGL_FORMAT_RGBA_8888_EXACT_KHR"},
    {0x30C3, "EGL_FORMAT_RGBA_8888_KHR"},
    {0x30C4, "EGL_MAP_PRESERVE_PIXELS_KHR"},
    {0x30C5, "EGL_LOCK_USAGE_HINT_KHR"},
    {0x30C6, "EGL_BITMAP_POINTER_KHR"},
    {0x30C7, "EGL_BITMAP_PITCH_KHR"},
    {0x30C8, "EGL_BITMAP_ORIGIN_KHR"},
    {0x30C9, "EGL_BITMAP_PIXEL_RED_OFFSET_KHR"},
    {0x30CA, "EGL_BITMAP_PIXEL_GREEN_OFFSET_KHR"},
    {0x30CB, "EGL_BITMAP_PIXEL_BLUE_OFFSET_KHR"},
    {0x30CC, "EGL_BITMAP_PIXEL_ALPHA_OFFSET_KHR"},
    {0x30CD, "EGL_BITMAP_PIXEL_LUMINANCE_OFFSET_KHR"},
    {0x30CE, "EGL_LOWER_LEFT_KHR"},
    {0x30CF, "EGL_UPPER_LEFT_KHR"},
    {0x30B0, "EGL_NATIVE_PIXMAP_KHR"},
    {0x30BA, "EGL_VG_PARENT_IMAGE_KHR"},
    {0x30B1, "EGL_GL_TEXTURE_2D_KHR"},
    {0x30BC, "EGL_GL_TEXTURE_LEVEL_KHR"},
    {0x30B3, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_X_KHR"},
    {0x30B4, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_X_KHR"},
    {0x30B5, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Y_KHR"},
    {0x30B6, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Y_KHR"},
    {0x30B7, "EGL_GL_TEXTURE_CUBE_MAP_POSITIVE_Z_KHR"},
    {0x30B8, "EGL_GL_TEXTURE_CUBE_MAP_NEGATIVE_Z_KHR"},
    {0x30B2, "EGL_GL_TEXTURE_3D_KHR"},
    {0x30BD, "EGL_GL_TEXTURE_ZOFFSET_KHR"},
    {0x30B9, "EGL_GL_RENDERBUFFER_KHR"},
    {0x30F1, "EGL_SYNC_STATUS_KHR"},
    {0x30F2, "EGL_SIGNALED_KHR"},
    {0x30F3, "EGL_UNSIGNALED_KHR"},
    {0x30F5, "EGL_TIMEOUT_EXPIRED_KHR"},
    {0x30F6, "EGL_CONDITION_SATISFIED_KHR"},
    {0x30F7, "EGL_SYNC_TYPE_KHR"},
    {0x30FA, "EGL_SYNC_REUSABLE_KHR"},
    {0x0001, "EGL_SYNC_FLUSH_COMMANDS_BIT_KHR"},
    {0x30D2, "EGL_IMAGE_PRESERVED_KHR"},
    {0x3100, "EGL_CONTEXT_PRIORITY_LEVEL_IMG"},
    {0x3101, "EGL_CONTEXT_PRIORITY_HIGH_IMG"},
    {0x3102, "EGL_CONTEXT_PRIORITY_MEDIUM_IMG"},
    {0x3103, "EGL_CONTEXT_PRIORITY_LOW_IMG"},
    {0x3110, "EGL_BITMAP_PIXEL_SIZE_KHR"},
    {0x30E0, "EGL_COVERAGE_BUFFERS_NV"},
    {0x30E1, "EGL_COVERAGE_SAMPLES_NV"},
    {0x30E2, "EGL_DEPTH_ENCODING_NV"},
    {0, "EGL_DEPTH_ENCODING_NONE_NV"},
    {0x30E3, "EGL_DEPTH_ENCODING_NONLINEAR_NV"},
    {0x30E6, "EGL_SYNC_PRIOR_COMMANDS_COMPLETE_NV"},
    {0x30E7, "EGL_SYNC_STATUS_NV"},
    {0x30E8, "EGL_SIGNALED_NV"},
    {0x30E9, "EGL_UNSIGNALED_NV"},
    {0x0001, "EGL_SYNC_FLUSH_COMMANDS_BIT_NV"},
    {0x30EA, "EGL_ALREADY_SIGNALED_NV"},
    {0x30EB, "EGL_TIMEOUT_EXPIRED_NV"},
    {0x30EC, "EGL_CONDITION_SATISFIED_NV"},
    {0x30ED, "EGL_SYNC_TYPE_NV"},
    {0x30EE, "EGL_SYNC_CONDITION_NV"},
    {0x30EF, "EGL_SYNC_FENCE_NV"},
    {0x30F0, "EGL_SYNC_PRIOR_COMMANDS_COMPLETE_KHR"},
    {0x30F8, "EGL_SYNC_CONDITION_KHR"},
    {0x30F9, "EGL_SYNC_FENCE_KHR"},
    {0x8F74, "EGL_CLIENT_PIXMAP_POINTER_HI"},
    {0x8F70, "EGL_COLOR_FORMAT_HI"},
    {0x8F71, "EGL_COLOR_RGB_HI"},
    {0x8F72, "EGL_COLOR_RGBA_HI"},
    {0x8F73, "EGL_COLOR_ARGB_HI"},
    {0x31D0, "EGL_DRM_BUFFER_FORMAT_MESA"},
    {0x31D1, "EGL_DRM_BUFFER_USE_MESA"},
    {0x31D2, "EGL_DRM_BUFFER_FORMAT_ARGB32_MESA"},
    {0x31D3, "EGL_DRM_BUFFER_MESA"},
    {0x31D4, "EGL_DRM_BUFFER_STRIDE_MESA"},
    {0x00000001, "EGL_DRM_BUFFER_USE_SCANOUT_MESA"},
    {0x00000002, "EGL_DRM_BUFFER_USE_SHARE_MESA"},
    {0x30BE, "EGL_POST_SUB_BUFFER_SUPPORTED_NV"},
    {0x3200, "EGL_D3D_TEXTURE_2D_SHARE_HANDLE_ANGLE"},
    {0x3131, "EGL_COVERAGE_SAMPLE_RESOLVE_NV"},
    {0x3132, "EGL_COVERAGE_SAMPLE_RESOLVE_DEFAULT_NV"},
    {0x3133, "EGL_COVERAGE_SAMPLE_RESOLVE_NONE_NV"},
    {0x00000001, "WGL_FRONT_COLOR_BUFFER_BIT_ARB"},
    {0x00000002, "WGL_BACK_COLOR_BUFFER_BIT_ARB"},
    {0x00000004, "WGL_DEPTH_BUFFER_BIT_ARB"},
    {0x00000008, "WGL_STENCIL_BUFFER_BIT_ARB"},
    {0x2041, "WGL_SAMPLE_BUFFERS_ARB"},
    {0x2042, "WGL_SAMPLES_ARB"},
    ...
    {0x208F, "WGL_AUX8_ARB"},
    {0x2090, "WGL_AUX9_ARB"},
    {0x21A0, "WGL_TYPE_RGBA_FLOAT_ARB"},
    {0x20A9, "WGL_FRAMEBUFFER_SRGB_CAPABLE_ARB"},
    {0x00000001, "WGL_CONTEXT_DEBUG_BIT_ARB"},
    {0x00000002, "WGL_CONTEXT_FORWARD_COMPATIBLE_BIT_ARB"},
    {0x2091, "WGL_CONTEXT_MAJOR_VERSION_ARB"},
    {0x2092, "WGL_CONTEXT_MINOR_VERSION_ARB"},
    {0x2093, "WGL_CONTEXT_LAYER_PLANE_ARB"},
    ...
    {0x00000004, "WGL_CONTEXT_ROBUST_ACCESS_BIT_ARB"},
    {0x8252, "WGL_LOSE_CONTEXT_ON_RESET_ARB"},
    {0x8256, "WGL_CONTEXT_RESET_NOTIFICATION_STRATEGY_ARB"},
    {0x8261, "WGL_NO_RESET_NOTIFICATION_ARB"},
    {0x2000, "WGL_NUMBER_PIXEL_FORMATS_EXT"},
    {0x2001, "WGL_DRAW_TO_WINDOW_EXT"},
    {0x2002, "WGL_DRAW_TO_BITMAP_EXT"},
    {0x2003, "WGL_ACCELERATION_EXT"},
    {0x2004, "WGL_NEED_PALETTE_EXT"},
    {0x2005, "WGL_NEED_SYSTEM_PALETTE_EXT"},
    {0x2006, "WGL_SWAP_LAYER_BUFFERS_EXT"},
    {0x2007, "WGL_SWAP_METHOD_EXT"},
    {0x2008, "WGL_NUMBER_OVERLAYS_EXT"},
    {0x2009, "WGL_NUMBER_UNDERLAYS_EXT"},
    {0x200A, "WGL_TRANSPARENT_EXT"},
    {0x200B, "WGL_TRANSPARENT_VALUE_EXT"},
    {0x200C, "WGL_SHARE_DEPTH_EXT"},
    {0x200D, "WGL_SHARE_STENCIL_EXT"},
    {0x200E, "WGL_SHARE_ACCUM_EXT"},
    {0x200F, "WGL_SUPPORT_GDI_EXT"},
    {0x2010, "WGL_SUPPORT_OPENGL_EXT"},
    {0x2011, "WGL_DOUBLE_BUFFER_EXT"},
    {0x2012, "WGL_STEREO_EXT"},
    {0x2013, "WGL_PIXEL_TYPE_EXT"},
    {0x2014, "WGL_COLOR_BITS_EXT"},
    {0x2015, "WGL_RED_BITS_EXT"},
    {0x2016, "WGL_RED_SHIFT_EXT"},
    {0x2017, "WGL_GREEN_BITS_EXT"},
    {0x2018, "WGL_GREEN_SHIFT_EXT"},
    {0x2019, "WGL_BLUE_BITS_EXT"},
    {0x201A, "WGL_BLUE_SHIFT_EXT"},
    {0x201B, "WGL_ALPHA_BITS_EXT"},
    {0x201C, "WGL_ALPHA_SHIFT_EXT"},
    {0x201D, "WGL_ACCUM_BITS_EXT"},
    {0x201E, "WGL_ACCUM_RED_BITS_EXT"},
    {0x201F, "WGL_ACCUM_GREEN_BITS_EXT"},
    {0x2020, "WGL_ACCUM_BLUE_BITS_EXT"},
    {0x2021, "WGL_ACCUM_ALPHA_BITS_EXT"},
    {0x2022, "WGL_DEPTH_BITS_EXT"},
    {0x2023, "WGL_STENCIL_BITS_EXT"},
    {0x2024, "WGL_AUX_BUFFERS_EXT"},
    {0x2025, "WGL_NO_ACCELERATION_EXT"},
    {0x2026, "WGL_GENERIC_ACCELERATION_EXT"},
    {0x2027, "WGL_FULL_ACCELERATION_EXT"},
    {0x2028, "WGL_SWAP_EXCHANGE_EXT"},
    {0x2029, "WGL_SWAP_COPY_EXT"},
    {0x202A, "WGL_SWAP_UNDEFINED_EXT"},
    {0x202B, "WGL_TYPE_RGBA_EXT"},
    {0x202C, "WGL_TYPE_COLORINDEX_EXT"},
    {0x202D, "WGL_DRAW_TO_PBUFFER_EXT"},
    {0x202E, "WGL_MAX_PBUFFER_PIXELS_EXT"},
    {0x202F, "WGL_MAX_PBUFFER_WIDTH_EXT"},
    {0x2030, "WGL_MAX_PBUFFER_HEIGHT_EXT"},
    {0x2031, "WGL_OPTIMAL_PBUFFER_WIDTH_EXT"},
    {0x2032, "WGL_OPTIMAL_PBUFFER_HEIGHT_EXT"},
    {0x2033, "WGL_PBUFFER_LARGEST_EXT"},
    {0x2034, "WGL_PBUFFER_WIDTH_EXT"},
    {0x2035, "WGL_PBUFFER_HEIGHT_EXT"},
    ...
    {0x00000001, "WGL_IMAGE_BUFFER_MIN_ACCESS_I3D"},
    {0x00000002, "WGL_IMAGE_BUFFER_LOCK_I3D"},
    ...
    {0x2055, "WGL_STEREO_EMITTER_ENABLE_3DL"},
    {0x2056, "WGL_STEREO_EMITTER_DISABLE_3DL"},
    {0x2057, "WGL_STEREO_POLARITY_NORMAL_3DL"},
    {0x2058, "WGL_STEREO_POLARITY_INVERT_3DL"},
    {0x20A8, "WGL_TYPE_RGBA_UNSIGNED_FLOAT_EXT"},
    {0x20A9, "WGL_FRAMEBUFFER_SRGB_CAPABLE_EXT"},
    {0x20F0, "WGL_NUM_VIDEO_SLOTS_NV"},
    {0x20C0, "WGL_BIND_TO_VIDEO_RGB_NV"},
    {0x20C1, "WGL_BIND_TO_VIDEO_RGBA_NV"},
    {0x20C2, "WGL_BIND_TO_VIDEO_RGB_AND_DEPTH_NV"},
    {0x20C3, "WGL_VIDEO_OUT_COLOR_NV"},
    {0x20C4, "WGL_VIDEO_OUT_ALPHA_NV"},
    {0x20C5, "WGL_VIDEO_OUT_DEPTH_NV"},
    {0x20C6, "WGL_VIDEO_OUT_COLOR_AND_ALPHA_NV"},
    {0x20C7, "WGL_VIDEO_OUT_COLOR_AND_DEPTH_NV"},
    {0x20C8, "WGL_VIDEO_OUT_FRAME"},
    {0x20C9, "WGL_VIDEO_OUT_FIELD_1"},
    {0x20CA, "WGL_VIDEO_OUT_FIELD_2"},
    {0x20CB, "WGL_VIDEO_OUT_STACKED_FIELDS_1_2"},
    {0x20CC, "WGL_VIDEO_OUT_STACKED_FIELDS_2_1"},
    {0x20D0, "WGL_ERROR_INCOMPATIBLE_AFFINITY_MASKS_NV"},
    {0x20D1, "WGL_ERROR_MISSING_AFFINITY_MASK_NV"},
    {0x1F00, "WGL_GPU_VENDOR_AMD"},
    {0x1F01, "WGL_GPU_RENDERER_STRING_AMD"},
    {0x1F02, "WGL_GPU_OPENGL_VERSION_STRING_AMD"},
    {0x21A2, "WGL_GPU_FASTEST_TARGET_GPUS_AMD"},
    {0x21A3, "WGL_GPU_RAM_AMD"},
    {0x21A4, "WGL_GPU_CLOCK_AMD"},
    {0x21A5, "WGL_GPU_NUM_PIPES_AMD"},
    {0x21A6, "WGL_GPU_NUM_SIMD_AMD"},
    {0x21A7, "WGL_GPU_NUM_RB_AMD"},
    {0x21A8, "WGL_GPU_NUM_SPI_AMD"},
    {0x20CE, "WGL_UNIQUE_ID_NV"},
    {0x20CF, "WGL_NUM_VIDEO_CAPTURE_SLOTS_NV"},
    {0x2042, "WGL_COVERAGE_SAMPLES_NV"},
    {0x20B9, "WGL_COLOR_SAMPLES_NV"},
    {0x00000004, "WGL_CONTEXT_ES2_PROFILE_BIT_EXT"},
    {0x00000000, "WGL_ACCESS_READ_ONLY_NV"},
    {0x00000001, "WGL_ACCESS_READ_WRITE_NV"},
    {0x00000002, "WGL_ACCESS_WRITE_DISCARD_NV"},
    {0x83FF, "GL_TEXTURE_MEMORY_LAYOUT_INTEL"},
    {0x0000, "GL_LAYOUT_DEFAULT_INTEL"},
    {0x0001, "GL_LAYOUT_LINEAR_INTEL"},
    {0x0002, "GL_LAYOUT_LINEAR_CPU_CACHED_INTEL"},
    {0x8032, "GL_UNSIGNED_BYTE_3_3_2"},
    {0x8033, "GL_UNSIGNED_SHORT_4_4_4_4"},
    {0x8034, "GL_UNSIGNED_SHORT_5_5_5_1"},
    {0x8035, "GL_UNSIGNED_INT_8_8_8_8"},
    ...
    {0x8C36, "GL_SAMPLE_SHADING_ARB"},
    {0x8C37, "GL_MIN_SAMPLE_SHADING_VALUE_ARB"},
    {0x9009, "GL_TEXTURE_CUBE_MAP_ARRAY_ARB"},
    {0x900A, "GL_TEXTURE_BINDING_CUBE_MAP_ARRAY_ARB"},
    {0x900B, "GL_PROXY_TEXTURE_CUBE_MAP_ARRAY_ARB"},
    {0x900C, "GL_SAMPLER_CUBE_MAP_ARRAY_ARB"},
    {0x900D, "GL_SAMPLER_CUBE_MAP_ARRAY_SHADOW_ARB"},
    {0x900E, "GL_INT_SAMPLER_CUBE_MAP_ARRAY_ARB"},
    {0x900F, "GL_UNSIGNED_INT_SAMPLER_CUBE_MAP_ARRAY_ARB"},
    {0x8E5E, "GL_MIN_PROGRAM_TEXTURE_GATHER_OFFSET_ARB"},
    {0x8E5F, "GL_MAX_PROGRAM_TEXTURE_GATHER_OFFSET_ARB"},
    {0x8DAE, "GL_SHADER_INCLUDE_ARB"},
    {0x8DE9, "GL_NAMED_STRING_LENGTH_ARB"},
    {0x8DEA, "GL_NAMED_STRING_TYPE_ARB"},
    {0x8E8C, "GL_COMPRESSED_RGBA_BPTC_UNORM_ARB"},
...
const char* gits::OpenGL::GetGLEnumString(GLenum glenum) {
  static std::map<unsigned int, const char*> glEnumMap;
  static std::list<std::string> strings;

  if (glEnumMap.empty()) {
    for (auto& elem : enums) {
      glEnumMap[elem.value] = elem.name;
    }
  }

  if (glEnumMap.find(glenum) == glEnumMap.end()) {
    std::stringstream convertStream;
    convertStream << glenum;
    strings.push_back(convertStream.str());
    glEnumMap[glenum] = strings.back().c_str();
  }

  return glEnumMap[glenum];
}
