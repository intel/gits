...
CapturePlayerGpuAddressService& CapturePlayerGpuAddressService::Get() {
  static CapturePlayerGpuAddressService instance;
  return instance;
}
...
void CapturePlayerGpuAddressService::GpuAddressService::DestroyInterface(unsigned interfaceKey) {
  {
    ...
    if (it != m_ResourcesByKey.end()) {
      ...
      assert(itAddr != m_ResourcesByAddress.end());
  ...
  }
  {
    ...
    if (it != m_PlacedResourcesByKey.end()) {
      ...
      assert(heapIt != m_HeapsByResourceKey.end());
